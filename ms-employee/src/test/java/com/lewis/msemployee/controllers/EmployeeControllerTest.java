...
@SqlGroup({
        @Sql(executionPhase = Sql.ExecutionPhase.BEFORE_TEST_METHOD, scripts = {
                "classpath:create-test.sql"}),
        @Sql(executionPhase = Sql.ExecutionPhase.AFTER_TEST_METHOD, scripts = {
                "classpath:delete-test.sql"})})
public class EmployeeControllerTest {
    ...
    {
        mockMvc.perform(MockMvcRequestBuilders.get("/v1/employees/{id}", "83304dc3-564e-45b3-b91b-905aa76b74c4"))
                .andExpect(status().isOk())
                .andExpect(content().contentType(APPLICATION_JSON_UTF8))
                .andExpect(jsonPath("$.id", is("83304dc3-564e-45b3-b91b-905aa76b74c4")))
        ...
        assertNotNull(employeeDao.getById(UUID.fromString("83304dc3-564e-45b3-b91b-905aa76b74c4")));
    }
    @Test
