...
public class ResourceExceptionHandler extends AbstractErrorWebExceptionHandler {
    ...
    public ResourceExceptionHandler(GlobalErrorAttributes globalErrorAttributes, ApplicationContext applicationContext,
    ...
    private Mono<ServerResponse> renderErrorResponse(ServerRequest request) {
        ...
        int statusCode = (int) errorPropertiesMap.get("status");
